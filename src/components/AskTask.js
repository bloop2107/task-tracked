...
const AskTask = ({onAdd}) => {
    ...
    return (
        <form className="w-full mt-4  transition ease-in" >
            ...
            <button onClick={addTask} className="transition ease-in w-full mt-4 mb-4 shadow bg-blue-500 hover:bg-blue-400 focus:shadow-outline focus:outline-none text-white font-bold py-2 px-4 rounded" type="submit">
                Save Task
            </button>
        </form>
    )
